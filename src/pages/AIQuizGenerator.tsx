...
import { Brain, Sparkles, Play, ArrowLeft } from 'lucide-react';
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="flex items-center gap-4 mb-8 mt-4">
          ...
          <div>
            ...
            <p className="text-gray-400">Generate custom quizzes on any topic using AI</p>
          </div>
        </div>
                    ...
                    <div key={index} className="border border-gray-700 rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-1 gap-2">
                        {question.options.map((option, optIndex) => (
                          <div
                            key={optIndex}
                            className="p-2 rounded border border-gray-700 bg-gray-800/50 text-gray-300 text-sm"
                          >
